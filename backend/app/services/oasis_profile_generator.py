...
logger = get_logger('agenikpredict.oasis_profile')
...
class OasisProfileGenerator:
    ...
    1. Calls ZepGraph retrieval for richer context
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """
        Use ZepGraph hybrid search to get rich entity-related info.
    ...
    def _build_entity_context(self, entity: EntityNode) -> str:
        ...
        2. Detailed info from related nodes
    ...
    def _generate_profile_with_llm(
        ...
        # Attempt generation multiple times until success or max retry attempts reached
        max_attempts = 3
        last_error = None
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        if json_match:
            ...
            # 3. Handle newline characters inside string values
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        ...
        base_prompt = "You are a social media user profile generation expert. Generate detailed, realistic personas for opinion simulation, recreating existing real-world situations as closely as possible. You must return valid JSON format. All string values cannot contain unescaped newlines. Use English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, recreating existing real-world situations as closely as possible.
...
2. persona: Detailed persona description (2000 words of plain text), must include:
   ...
   - Personal memories (important part of the persona; introduce this individual's connection to the event, and this individual's existing actions and reactions in the event)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for this institutional/group entity, recreating existing real-world situations as closely as possible.
...
2. persona: Detailed account profile description (2000 words of plain text), must include:
   - Institutional basic information (official name, type of institution, founding background, main functions)
   ...
   - Institutional memory (important part of the persona; introduce this institution's connection to the event, and this institution's existing actions and reactions in the event)
...
- Institutional account speech should match its identity positioning"""
    ...
    def generate_profiles_from_entities(
        ...
        completed_count = [0]  # Use list to allow modification inside closure
        lock = Lock()
    ...
    def _normalize_gender(self, gender: Optional[str]) -> str:
        ...
        # Chinese-to-English mapping (needed for parsing legacy data)
        gender_map = {
            "male": "male",
            "female": "female",
            "organization": "other",
