...
from ..utils.locale import get_language_name, get_llm_language_instruction
...
class OntologyGenerator:
    ...
    def generate(
        ...
        Args:
            ...
            language: Locale code (e.g. 'en', 'he', 'ru') for LLM response language
        ...
        # Add language instruction to system prompt if non-English locale
        ...
        if lang_instruction:
            ...
            system_prompt += f'\nThe analysis_summary field must be in {lang_name}.'
...
"""
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            'Auto-generated by AgenikPredict for social opinion simulation',
            '"""',
            '',
