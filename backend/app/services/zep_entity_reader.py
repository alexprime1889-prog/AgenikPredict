...
logger = get_logger('agenikpredict.zep_entity_reader')
...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If node Labels only contain "Entity", the entity does not match our predefined types, skip
        - If node Labels contain labels other than "Entity" and "Node", it matches predefined types, keep
        
        Args:
            graph_id: Graph ID
            defined_entity_types: Predefined entity types list (optional, keeps only these types if provided)
