...
logger = get_logger('agenikpredict.zep_tools')
...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-questions, plus comprehensive analysis
    """
    query: str
...
class ZepToolsService:
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Gets all graph edges, then filters edges related to specified nodes
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, auto-decomposes questions and retrieves from multiple dimensions:
    ...
    def _generate_sub_queries(
        ...
        Decompose complex problem into multiple independently retrievable sub-questions
        """
...
Requirements:
1. Each sub-question should be specific enough to find related Agent behaviors or events
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        3. Classify and organize currently valid and historical info
        
        This tool is suitable for understanding the full picture of events and tracking evolution processes.
    ...
    def interview_agents(
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplementary): Extract long text within properly paired quotation marks
                if not key_quotes:
...
Selection criteria:
1. Agent's identity/occupation is related to the interview topic
...
3. Cover multiple dimensions including facts, opinions, feelings
...
2. Identify consensus and divergence of opinions
