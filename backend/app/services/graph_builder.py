...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        graph_name: str = "AgenikPredict Graph",
        chunk_size: int = 500,
    ...
    def create_graph(self, name: str) -> str:
        ...
        graph_id = f"agenikpredict_{uuid.uuid4().hex[:16]}"
        
        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="AgenikPredict Social Simulation Graph"
        )
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required by Zep SDK, warnings come from dynamic class creation, safe to ignore
