  ...
  <div class="main-view">
    ...
    <header class="app-header">
      ...
      <div class="header-right">
        ...
        <button class="theme-toggle" @click="toggleTheme" :title="isDark ? 'Light mode' : 'Dark mode'" :aria-label="isDark ? 'Switch to light mode' : 'Switch to dark mode'">
...
const handleNextStep = (params = {}) => {
  if (currentStep.value < 5) {
    ...
    // If moving from Step 2 to Step 3, log custom rounds config
