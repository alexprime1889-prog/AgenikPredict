        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div class="chat-input-area">
            <textarea 
              v-model="chatInput"
              class="chat-input"
              :placeholder="$t('step5.inputPlaceholderFull')"
...
const renderMarkdown = (content) => {
  ...
  // Fix ordered list numbering when single-item <ol> separated by paragraphs
...
/* Fix ordered list numbering - CSS counters for continuous ol */
.message-text {
