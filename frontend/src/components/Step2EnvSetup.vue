    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="phase === 2" class="badge processing">{{ $t('step2.configGenerating') }}</span>
            <span v-else class="badge pending">{{ $t('step1.pending') }}</span>
          </div>
        </div>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-block-header">
                ...
                <span class="config-block-badge">{{ $t('step2.agentCount', { count: simulationConfig.agent_configs?.length || 0 }) }}</span>
              </div>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ $t('step2.recommendAlgorithm') }}</span>
              </div>
              <div class="platforms-grid">
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">{{ $t('step2.platform2Community') }}</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">{{ $t('step2.recencyWeight') }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Simulation rounds config - show only after config and rounds are ready -->
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        {{ $t('step2.estimatedTimeFull', { minutes: Math.round(autoGeneratedRounds * 0.6) }) }}
                      </span>
                    </div>
                    <div class="auto-desc">
    ...
    <Transition name="modal">
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        <div class="profile-modal">
          ...
          <button class="close-btn" @click="selectedProfile = null" :aria-label="$t('common.close')">×</button>
        </div>
...
watch(currentStage, (newStage) => {
  if (newStage === 'generating_profiles_zh' || newStage === 'generating_profiles') {
    phase.value = 1
  } else if (newStage === 'generating_config_zh' || newStage === 'generating_config') {
    phase.value = 2
  ...
  } else if (newStage === 'copying_scripts_zh' || newStage === 'copying_scripts') {
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Detected existing preparation, reusing...')
